        ...
        <div class="container" :style="style">
            <div class="center">
                <div class="center_header">
                    <!-- <h2>{{cityname}}</h2> -->
                    <div>
                        <el-select v-model="cityname" @change="provinceNamechange(cityname)"
                ...
                <div class="left_body">
                    <div class="">
                        ...
                        <div style="height:100%">
                            ...
                            >
                                ...
                                <el-table-column prop="highRiseFee" label="高层" min-width="30px"
                                                 align="center"></el-table-column>
                                <el-table-column prop="westernFee" label="洋房" min-width="30px"
                                                 align="center"></el-table-column>
                                <el-table-column prop="villaFee" label="别墅" min-width="30px"
                                                 align="center"></el-table-column>
                                <el-table-column prop="businessFee" label="商业" min-width="30px"
                                                 align="center"></el-table-column>
                                <el-table-column prop="garageFee" label="车库" min-width="30px"
                                                 align="center"></el-table-column>
                                <el-table-column prop="remark" label="备注" min-width="30px" align="center"
                    ...
                    <div>
                        ...
                        >
                            ...
                            <el-table-column prop="villaFee" label="别墅" min-width="30px"
                                             align="center"></el-table-column>
                            <el-table-column prop="businessFee" min-width="30px" label="商业"
                                             align="center"></el-table-column>
                            <el-table-column prop="garageFee" label="车库" min-width="30px"
                                             align="center"></el-table-column>
                            <el-table-column prop="remark" label="备注" min-width="30px" align="center"
