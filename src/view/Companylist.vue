                ...
                <div class="container_body">
                            ...
                            <div>
                                ...
                                <div>
                                    <ul>
                                        ...
                                        <li>官方网址:</li>
                                        &nbsp;<li @click="open(data.officialwebsite)"
                                                  style="cursor: pointer;color:#007af4;text-decoration:underline; "
                                                  :title="data.officialwebsite">{{data.officialwebsite}}
                                    </li>
                                    </ul>
                                    <ul>
                                        <li>上市时间:</li>
                    ...
                    <div class="container_body_right">
                        <div class="container_body_right_header">
                            <h1 v-for="(item,index) in qnbn " :key="index" :class="{active:index==num}"
                                @click="btn(index)">{{item}}</h1>
                        </div>
