        ...
        <div class="container">
            <div class="container_left">
                <div class="container_left_header">
                    ...
                    <div>
                        <h2>查询年份</h2>
                        <el-select v-model="region" placeholder @change="chickvalue(region)" style="width:200px;"
                                   class="input1">
                            <el-option
                ...
                <div class="container_right_header">
                    ...
                    <div class="container_left_header_tab">
                        <el-table :data="Merger" style="width: auto;height:312px" fit:true border>
                            <el-table-column prop="acquiringfirm" label="收购方" min-width="80x"
                                             :show-overflow-tooltip="true" align="left"
                                             style="fontWeight:500"></el-table-column>
                            <el-table-column prop="acquiree" label="被收购方" min-width="80px" :show-overflow-tooltip="true"
                                             align="left"></el-table-column>
                            <el-table-column prop="acquisitiontime" label="日期" min-width="80px"
                                             :show-overflow-tooltip="true" align="left"></el-table-column>
                            <el-table-column prop="capital" label="资金(亿)" min-width="70px" :show-overflow-tooltip="true"
                                             align="left"></el-table-column>
                            <el-table-column prop="ratio" label="占比" min-width="40px" :show-overflow-tooltip="true"
                                             align="left"></el-table-column>
                        </el-table>
                    </div>
                </div>
