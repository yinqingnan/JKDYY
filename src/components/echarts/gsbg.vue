...
export default {
    ...
    mounted(){
        ...
        this.axios.get("/api/prochargeRate09?projectId="+this.xmid+"&topCount=10").then((res)=>{
            ...
            // this.data1=res.data.data
                ...
                for (let key in res.data.data) {
                  ...
                  let myChart = echarts.init(document.getElementById('gsbg'));
      var colorArray = [{
        top: '#69b3e2',
        bottom: '#688ee5'
    }, {
