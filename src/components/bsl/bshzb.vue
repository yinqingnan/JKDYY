        ...
        >
          ...
          <el-table-column label="综合" align="center">
            ...
            <el-table-column
              ...
              min-width="55px"
            >
              <template slot-scope="scope">{{scope.row.synthesizeFinishRate}}%</template>
            </el-table-column>
          </el-table-column>
          <el-table-column label="审核" align="center">
            ...
            <el-table-column
              ...
              min-width="55px"
            >
              <template slot-scope="scope">{{scope.row.auditRate}}%</template>
            </el-table-column>
          </el-table-column>
          <el-table-column label="派工" align="center">
            ...
            <el-table-column
              ...
              min-width="55px"
            >
              <template slot-scope="scope">{{scope.row.jobRate}}%</template>
            </el-table-column>
          </el-table-column>
