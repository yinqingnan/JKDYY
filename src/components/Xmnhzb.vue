                ...
                <div>
                    ...
                    <div class="box_header_right">
                        ...
                        <div class="box_header_right_header">
                            ...
                            >
                                <el-table-column prop="stateType" label="分析项" :show-overflow-tooltip="true"
                                                 align="center" min-width="58px"></el-table-column>
                                <el-table-column prop="m1" label="1月" :show-overflow-tooltip="true" align="center"
                                                 min-width="46px">
                                ...
                                <el-table-column prop="m2" label="2月" :show-overflow-tooltip="true" align="center"
                                                 min-width="45px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m3" label="3月" :show-overflow-tooltip="true" align="center"
                                                 min-width="45px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m4" label="4月" :show-overflow-tooltip="true" align="center"
                                                 min-width="45px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m5" label="5月" :show-overflow-tooltip="true" align="center"
                                                 min-width="46px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m6" label="6月" :show-overflow-tooltip="true" align="center"
                                                 min-width="46px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m7" label="7月" :show-overflow-tooltip="true" align="center"
                                                 min-width="46px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m8" label="8月" :show-overflow-tooltip="true" align="center"
                                                 min-width="46px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m9" label="9月" :show-overflow-tooltip="true" align="center"
                                                 min-width="46px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m10" label="10月" :show-overflow-tooltip="true" align="center"
                                                 min-width="52px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m11" label="11月" :show-overflow-tooltip="true" align="center"
                                                 min-width="50px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
                                ...
                                <el-table-column prop="m12" label="12月" :show-overflow-tooltip="true" align="center"
                                                 min-width="52px">
                                    <template slot-scope="scope">
                                        <span
                                                size="mini"
