    ...
    <div>
        <div class="box">
            ...
            >
                ...
                <el-table-column prop="waterMeter" label="表号" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                ...
                <el-table-column prop="dosage" label="用量（吨）" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                ...
                <el-table-column prop="payer" label="缴费人" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="ascription" label="用水归属" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
