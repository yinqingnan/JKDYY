    ...
    <div>
        <div class="box">
            <div class="boxTitle ">
                ...
                <div class="select">
                    <el-select v-model="yeardefaultdefault" placeholder="请选择年份" @change="yearchange(yeardefaultdefault)"
                    ...
                    <el-select v-model="monthdefaultdefault" placeholder="请选择月份"
                               @change="monthchange(monthdefaultdefault)" style="width:100px;text-align: center;">
                        <el-option
            ...
            >
                ...
                <el-table-column prop="itemName" label="名称" min-width="106px" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="electricityMeter" label="表号" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="beginNumber" label="起数" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="endNumber" label="止数" :show-overflow-tooltip="true" align="center"
                                 min-width="122px"></el-table-column>
                <el-table-column prop="dosage" label="用量（度）" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="unitPrice" label="单价" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="amount" label="金额" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="payer" label="缴费人" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="ascription" label="用电归属" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
            </el-table>
            <div class="box1">
                <el-pagination
