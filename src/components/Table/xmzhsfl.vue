        ...
        <div class="box" id="srylb">
            ...
            >
                ...
                <el-table-column
                        ...
                        align="center"
                ></el-table-column>
                <el-table-column prop="targetValue" label="目标值" :show-overflow-tooltip="true" align="center"
                ...
                <el-table-column
                        ...
                        min-width="120px"
                ></el-table-column>
                <el-table-column prop="someYieldRate" label="目标达成率" :show-overflow-tooltip="true" align="center"
                                 min-width="94px">
                    <template slot-scope="scope">
                        <span v-show="scope.row.someYieldRate">{{scope.row.someYieldRate}}%</span>
                    </template>
                </el-table-column>
                <el-table-column prop="lastYearSome" label="去年同期" :show-overflow-tooltip="true" align="center"
                                 min-width="76px"></el-table-column>
                <el-table-column prop="yieldRate" label="同期达成率" :show-overflow-tooltip="true" align="center"
                                 min-width="90px">
                    <template slot-scope="scope">
