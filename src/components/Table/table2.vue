    ...
    <div>
        <div class="box" id="box">
            ...
            >
                ...
                <el-table-column prop="isBidding" label="是否招投标" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="noTenderReason" label="未招投标原因" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="recordPrice" label="备案价格" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="actualPrice" label="实际收费价格" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="exceedRecordPrice" label="是否超出备案价格" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
                <el-table-column prop="exceedRecordPriceReason" label="若超出备案价格，说明原因 " :show-overflow-tooltip="true"
                                 align="center" min-width="120px"></el-table-column>
                <el-table-column prop="supervisoryReceipt" label="监制回执是否取得" :show-overflow-tooltip="true"
                                 align="center"></el-table-column>
